...
<body>
    ...
    <!-- <div class="banner" style="margin-top: 0;">
        <img src="/Public/Home/images/dianka.jpg" width="100%" height="100%"/>
    </div> -->
    <br>
    <br>
    ...
    <div class="mui-input-row">
            ...
            <div class="mui-input-row">
                <label>累计用量:</label>
                <input type="text" id="DQYE" placeholder="请先选择房屋住址" value="" disabled/>
            </div>
            <div class="mui-input-row">
                <label>当日余量:</label>
...
<script>
    $(function () {
        ...
        $("#WechatPayment").click(function(){
			...
			$.ajax({
                    'url' : '/index.php/Home/Index/water_list',
                    'type' : 'post',
                    'data' : data,
                    'dataType' : 'json',
                    'success' : function(response){
        ...
        $("#PaypalPayment").click(function(){
			...
			$.ajax({
                    'url' : '/index.php/Home/Index/electric_list',
                    'type' : 'post',
                    'data' : data,
                    'dataType' : 'json',
                    'success' : function(response){
