...
class Weixinpay {
    ...
    private $config=array(
        ...
        'NOTIFY_URL'         => 'http://zncanting.com/shuidian/index.php/Api/WeixinPay/notify/order_number/', // 接收支付状态的连接  改成自己的域名
        );
    // 构造函数
    ...
    **/
    ...
    public function getParameters(){
        ...
        if (!isset($_GET['code'])) {
			...
			$redirect_uri='http://www.zncanting.com/shuidian/index.php/Api/Weixinpay/pay';
			...
			$res=explode('-',$out_trade_no);
			//dump($out_trade_no);dei;
            // 组合获取prepay_id的url
